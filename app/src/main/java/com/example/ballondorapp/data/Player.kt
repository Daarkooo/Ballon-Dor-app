...
val players = listOf(
    ...
    Player(R.drawable.ronaldo, R.string.ronaldo,"Brazil" ,R.string.ronaldo_description),
    Player(R.drawable.ronaldinho, R.string.ronaldinho,"Brazil", R.string.ronaldinho_description),
